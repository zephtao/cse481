...
var ImageViewer = function (props) {
    ...
    if (props.disabled) {
        return (react_1.default.createElement("img", { src: "", alt: "", style: style }));
    }
    else {
        ...
        return (react_1.default.createElement("img", { src: src, width: props.containerWidth, height: props.containerHeight, alt: "", style: style }));
    }
};
